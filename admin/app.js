...
$("offerSave").onclick=async()=>{
 ...
 const {error}=await db.from("offers").insert({title,subtitle,link_url:link,image_url,sort_order:Math.floor(Date.now()/1000),is_active:true});
